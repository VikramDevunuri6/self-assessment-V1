...
const CAN_REGENERATE_ROLES = [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.ASSESSMENT_MANAGER];
...
export default function ReportTab({ sessionId }) {
  ...
  const user = getUser();
  const canRegenerate = CAN_REGENERATE_ROLES.includes(user?.role);
